...
if(isset($_POST['leave_type'])){
	...
	if($id>0){
		...
		$sql="insert into leave_type(id,leave_type) values('$leave_id' ,'$leave_type')";
	}
                        ...
                        <div class="card-body card-block">
                           <form method="post">
                           	<div class="form-group">
								<label for="leave_type" class=" form-control-label">Leave Id</label>
								<input type="text" value="<?php echo $id?>" name="leave_id" placeholder="Enter leave Id" class="form-control" required></div>
							   <div class="form-group">
